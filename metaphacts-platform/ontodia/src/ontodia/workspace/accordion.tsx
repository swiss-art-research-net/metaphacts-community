...
export interface Props {
    ...
    children?: React.ReactElement<AccordionItemProps> |
        ReadonlyArray<React.ReactElement<AccordionItemProps>>;
...
export class Accordion extends React.Component<Props, State> {
    ...
    private originSizes: ReadonlyArray<number> | undefined;
    private originCollapsed: ReadonlyArray<boolean> | undefined;
    private originTotalSize: number | undefined;
    ...
    componentDidUpdate(prevProps: Props, prevState: State) {
        const {direction, children, onResize, animationDuration} = this.props as RequiredProps;
    ...
    private updateSizes = () => {
        ...
        this.setState(({collapsed}): Pick<State, 'sizes' | 'percents' | 'collapsed'> => {
    ...
    private renderItems() {
        ...
        return React.Children.map(children, (child, index) => {
            ...
            const additionalProps: Partial<AccordionItemProps> & React.Props<AccordionItem> = {
    ...
    private onBeginDragHandle = (itemIndex: number) => {
        ...
        this.setState({resizing: true}, () => {
            const {direction, onStartResize} = this.props as RequiredProps;
            if (onStartResize) {
