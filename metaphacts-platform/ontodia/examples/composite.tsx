...
const data: string = require('./resources/orgOntology.ttl');
...
class CompositeExample extends React.Component {
    render() {
        return (
        ...
        workspace.getModel().importLayout({
            ...
            dataProvider: new CompositeDataProvider(
                [
                    ...
                    {name: 'LOD Provider', dataProvider: lodDataProvider},
                ],
...
renderExample(<CompositeExample />);
