...
/**
 * DTO class representing a SELECT query template, including information about the query itself and
...
public class SelectQuery extends Query<ParsedTupleQuery> {
    ...
    public SelectQuery(final Resource id, final String label, final String description,
    ...
    @Override
    protected ParsedTupleQuery getQueryInternal()
