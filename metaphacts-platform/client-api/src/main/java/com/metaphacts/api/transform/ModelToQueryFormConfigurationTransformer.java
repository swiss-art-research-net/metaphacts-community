...
import com.metaphacts.api.dto.uiform.DatePicker;
import com.metaphacts.api.dto.uiform.TextInput;
import com.metaphacts.api.dto.uiform.TextInput.InputType;
 ...
 * @author msc, jt
 */
public class ModelToQueryFormConfigurationTransformer implements ModelToDtoTransformer<QueryFormConfiguration<QueryTemplate<?>>> {
	...
	@Override
	public QueryFormConfiguration<QueryTemplate<?>> modelToDto(final Model model) throws InvalidQueryFormConfigurationModelException {
        ...
        try {
            ...
            for(Value el : formElementIdentifier){
                ...
                if(!argType.equals(QF.QUERY_FORM_ELEMENT_CLASS))
                    throw new InvalidQueryFormConfigurationModelException(
                        "Form element  "+ el.stringValue() + " of form " + queryFormId + 
                        " must be typed as qf:QueryFormElement", null /* cause */);
                ...
                QueryFormElement formElement= new QueryFormElement( (IRI) el, elLabel, elDescription, queryArgument, uiElement);
        ...
        final QueryFormConfiguration<QueryTemplate<?>> ret =
            new QueryFormConfiguration<QueryTemplate<?>>(queryFormId, label, description, queryTemplateDto, formElements);
	...
	private QueryTemplate<?> getQueryTemplate(IRI queryTemplateId) throws InvalidQueryFormConfigurationModelException {
	    ...
	    try {
	        ...
	        if (queryTemplateDto==null) 
	            throw new InvalidQueryFormConfigurationModelException(
	                "Query template resolved to null", null /* cause */);
	    } catch (APICallFailedException e) {
	        throw new InvalidQueryFormConfigurationModelException(
	            "Recursive API call for suggestion query resolution for query " + queryTemplateId + 
	            " in query form configuration could not be resolved", e);
	    }
