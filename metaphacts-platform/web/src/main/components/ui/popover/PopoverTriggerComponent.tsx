...
interface PopoverTriggerConfig {
  /**
...
export type PopoverTriggerProps = PopoverTriggerConfig;

export type PopoverTriggerType = 'click' | 'hover' | 'focus';

export class PopoverTriggerComponent extends React.Component<PopoverTriggerProps, {}> {
  render() {
