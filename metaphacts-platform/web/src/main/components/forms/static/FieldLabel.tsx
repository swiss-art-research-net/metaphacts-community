...
interface SemanticFormFieldLabelConfig {
  for: string;
  className?: string;
  style?: React.CSSProperties;
}

export interface FieldLabelProps extends SemanticFormFieldLabelConfig, StaticComponentProps {
  for: string;
}

const CLASS_NAME = 'field-label';

export class FieldLabel extends StaticComponent<FieldLabelProps, {}> {
  render() {
