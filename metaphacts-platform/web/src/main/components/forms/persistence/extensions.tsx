...
export interface TriplestorePersistences {
  [name: string]: (configuration: object) => TriplestorePersistence;
}

export const TriplestorePersistenceExtension = new ExtensionPoint<TriplestorePersistences>();
