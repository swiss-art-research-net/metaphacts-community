...
export type RelationDisjunct = EntityDisjunct | TemporalDisjunct | SpatialDisjunct |
  LiteralDisjunct | NumericRangeDisjunct;

export type EntityDisjunct =
    ResourceDisjunct | SetDisjunct | SavedSearchDisjunct | SearchDisjunct;

export type TemporalDisjunct =
    DateDisjunct | DateRangeDisjunct | DateDeviationDisjunct |
    YearDisjunct | YearRangeDisjunct | YearDeviationDisjunct;

export type DateDisjunctValue =
    DateValue | DateRange | DateDeviation |
    YearValue | YearRange | YearDeviation;
...
export function matchConjunct<T>(matcher: ConjunctMatcher<T>) {
  return function(conjunct: Conjunct) {
    switch (conjunct.kind) {
      case ConjunctKinds.Relation: return matcher[ConjunctKinds.Relation](conjunct);
      case ConjunctKinds.Text: return matcher[ConjunctKinds.Text](conjunct);
    }
  };
}
...
export interface DisjunctMatcher<T> extends EntityDisjunctMatcher<T>,
  TemporalDisjunctMatcher<T>, SpatialDisjunctMatcher<T>,
  TextDisjunctMatcher<T>, LiteralDisjunctMatcher<T>, NumericRangeDisjunctMatcher<T> {
}
...
export interface GraphScopeResults {
  ...
  columns: Array<{ id: string; tgConcept: { label: string; color: string } }>;
}
