...
export { Canvas, subscribeOnCanvasCommands } from './Canvas';
...
export { OntodiaDataProviders, OntodiaDataProvidersProps } from './data/OntodiaDataProviders';
export {
  OntodiaSparqlDataProvider, OntodiaSparqlDataProviderProps,
} from './data/OntodiaSparqlDataProvider';
export { OntodiaRdfDataProvider, OntodiaRdfDataProviderProps } from './data/OntodiaRdfDataProvider';

export { WorkspaceLayout, WorkspaceColumn, WorkspaceRow, WorkspaceItem } from './workspace';
