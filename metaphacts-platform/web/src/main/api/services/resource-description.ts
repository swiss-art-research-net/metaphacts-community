...
const DESCRIPTION_SERVICE_URL = '/rest/data/rdf/utils/getDescriptionForRdfValue';
const service = new class extends BaseResourceService {
  constructor() {
    super(DESCRIPTION_SERVICE_URL);
  }
...
export function getDescription(iri: Rdf.Iri, options?: { context?: QueryContext }) {
  return service.getResource(iri, options ? options.context : undefined);
}

export function getDescriptions(
  iris: ReadonlyArray<Rdf.Iri>, options?: { context?: QueryContext }
) {
