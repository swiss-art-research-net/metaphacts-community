...
export const DATATYPES_FIXTURIES: DataTypeSuit[] = [
  ...
  },
  {
    ...
    values: {
      valid: [
        '2001-10-26', '2001-10-26+02:00', '2001-10-26Z',
        '2001-10-26+00:00', '-2001-10-26', '-20000-04-01',
      ],
      invalid: ['A', '1'],
    },
  ...
  },
  {
    ...
    invalidMessage:
      'Integer value is too big, maximum is 9223372036854776000 for datatype xsd:long',
  },
  {
  ...
  },
  {
    ...
    values: {
      valid: [
        'http://data.com', 'http://data.com/bar#foo', 'urn:example:org', 'mailto:info@data.com',
        'http://www.metaphacts.com/resource/test34a7e382-2a7e-4334-b3d1-5a6426c2e5e4/test',
        'http://test.com/Ümläüts',
      ],
