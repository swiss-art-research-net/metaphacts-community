...
const PROPS: Forms.FieldDescriptionProps = {
  for: 'test',
  definition: Forms.normalizeFieldDefinition(FIELD_DEFINITION),
  model: undefined,
};

describe('Description', () => {
  const descriptionComponent = shallow(createElement(Forms.FieldDescription, PROPS));
