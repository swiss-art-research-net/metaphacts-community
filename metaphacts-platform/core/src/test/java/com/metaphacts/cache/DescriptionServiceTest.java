...
/**
 * Test cases for {@link DescriptionService} functionality
 * in the part of description cache.
 *
 * @author Daniil Razdiakonov <dr@metaphacts.com>
 */
public class DescriptionServiceTest extends AbstractRepositoryBackedIntegrationTest {
    ValueFactory vf = SimpleValueFactory.getInstance();

    private final static String CUSTOM_NAMESPACE = "http://my.custom.namespace/";

    protected final static String IRI1 = CUSTOM_NAMESPACE + "s1";
    protected final static String IRI1_DESCRIPTION_NOLANG = "Description s1 (no language tag)";
    protected final static String IRI1_DESCRIPTION_EN = "Description s1 (en)";
    protected final static String IRI1_DESCRIPTION_DE = "Description s1 (de)";
    protected final static String IRI1_DESCRIPTION_RU = "Description s1 (ru)";
    protected final static String IRI1_DESCRIPTION_FR = "Description s1 (fr)";

    protected final static String IRI2 = CUSTOM_NAMESPACE + "s2";
    protected final static String IRI2_DESCRIPTION_NOLANG = "Description s2 (no language tag)";
    protected final static String IRI2_DESCRIPTION_EN = "Description s2 (en)";
    protected final static String IRI2_DESCRIPTION_DE = "Description s2 (de)";
    protected final static String IRI2_DESCRIPTION_RU = "Description s2 (ru)";
    protected final static String IRI2_DESCRIPTION_FR = "Description s2 (fr)";

    protected final static String IRI3 = CUSTOM_NAMESPACE + "s3";
    protected final static String IRI3_DESCRIPTION_EN = "Description s3 (en)";
    protected final static String IRI3_DESCRIPTION_DE = "Description s3 (de)";
    protected final static String IRI3_DESCRIPTION_FR = "Description s3 (fr)";

    protected final static String CUSTOM_DESCRIPTION = CUSTOM_NAMESPACE + "description";

    protected final static String LANGUAGE_TAG_DE = "de";
    protected final static String LANGUAGE_TAG_EN = "en";
    protected final static String LANGUAGE_TAG_RU = "ru";
    protected final static String LANGUAGE_TAG_FR = "fr";
