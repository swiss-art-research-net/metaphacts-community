...
public class PropertyBasedResourceDescriptionCacheTest extends DescriptionServiceTest {
    ...
    @Test
    public void testExtractCompositeDescriptionWithDefaultLanguageTag() throws Exception {
