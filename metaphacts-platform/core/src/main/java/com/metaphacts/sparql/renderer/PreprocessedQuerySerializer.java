...
public class PreprocessedQuerySerializer extends AbstractQueryModelVisitor<RuntimeException> {
    ...
    protected enum NonIriFunctions {
        STRLANG, STRDT, UUID, STRUUID, RAND, NOW, TZ, MD5, SHA1, SHA256, SHA384, SHA512;
    ...
    protected AbstractSerializableParsedQuery currentQueryProfile = null;
    
    protected SerializableParsedUpdate currentUpdate = null;
