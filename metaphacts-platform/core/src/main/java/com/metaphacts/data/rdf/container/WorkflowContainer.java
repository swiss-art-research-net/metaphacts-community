 ...
 * workflows, which operate in a container mode. Each child container contains a set
 * of statements generated by any client-side workflow. With every update of a
 * particular workflow instance, the entire child container (for that particular
 * workflow) will be replaced by a new set of statements. Used by
    ...
    public void initialize() {
        ...
        if (!getReadConnection().hasOutgoingStatements(this.getResourceIRI())) {
            ...
            m.add(vf.createStatement(IRI, RDFS.LABEL,
                    vf.createLiteral("Workflow Container")));
            m.add(vf.createStatement(IRI, RDFS.COMMENT, vf.createLiteral("Container to store Workflow Instantiations.")));
            try {
