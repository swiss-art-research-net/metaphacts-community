 ...
 * forms, which operate in a container mode. Each child container contains a set
 * of statements generated by any client-side form. With every update of a
 * particular form instance, the entire child container (for that particular
 * form) will be replaced by a new set of statements. Used by
 * {@link FormPersistenceLdpEndpoint}.
 * 
 * @author Johannes Trame <jt@metaphacts.com>
 */
@LDPR(iri= FormContainer.IRI_STRING)
public class FormContainer extends DefaultLDPContainer {
    ...
    public void initialize() {
        ...
        if (!getReadConnection().hasOutgoingStatements(this.getResourceIRI())) {
            ...
            m.add(vf.createStatement(IRI, RDFS.LABEL,
                    vf.createLiteral("Form Container")));
            m.add(vf.createStatement(IRI, RDFS.COMMENT, vf.createLiteral("Container to store statement created by froms.")));
            try {
