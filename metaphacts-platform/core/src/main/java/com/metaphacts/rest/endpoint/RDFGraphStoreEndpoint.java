...
public class RDFGraphStoreEndpoint {
    ...
    public Response createGraph(
        ...
        if (!PermissionUtil.hasGraphStorePermission(SPARQL.GRAPH_STORE_CREATE, graphUri)) {
            return Response.status(Status.FORBIDDEN)
                    .entity("No permission to create the named graph " + graphUri.stringValue()).build();
        }
    ...
    public Response getGraph(final @NotNull @QueryParam("graph") IRI uri,
        ...
        if (!PermissionUtil.hasGraphStorePermission(SPARQL.GRAPH_STORE_GET, uri)) {
            return Response.status(Status.FORBIDDEN)
                    .entity("No permission to fetch the named graph " + uri.stringValue()).build();
        }
    ...
    public Response deleteGraph(@QueryParam("graph") IRI uri,
        ...
        if (!PermissionUtil.hasGraphStorePermission(SPARQL.GRAPH_STORE_DELETE, uri)) {
            return Response.status(Status.FORBIDDEN)
                    .entity("No permission to delete the named graph " + uri.stringValue()).build();
        }
    ...
    public Response updateGraph(
        ...
        if (!PermissionUtil.hasGraphStorePermission(SPARQL.GRAPH_STORE_UPDATE, graphUri)) {
            return Response.status(Status.FORBIDDEN)
                    .entity("No permission to update the named graph " + graphUri.stringValue()).build();
        }
    ...
    public Response checkGraph(final @NotNull @QueryParam("graph") IRI uri,
        ...
        if (!PermissionUtil.hasGraphStorePermission(SPARQL.GRAPH_STORE_HEAD, uri)) {
            return Response.status(Status.FORBIDDEN)
                    .entity("No permission to get metadata for the named graph " + uri.stringValue()).build();
        }
