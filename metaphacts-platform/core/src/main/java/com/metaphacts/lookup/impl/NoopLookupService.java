...
/**
 * LookupService which does not return any results.
 * @author Wolfgang Schell <ws@metaphacts.com>
 */
public class NoopLookupService extends AbstractLookupService<CommonLookupConfig> {
    public NoopLookupService(CommonLookupConfig config) {
        super(config);
    }
