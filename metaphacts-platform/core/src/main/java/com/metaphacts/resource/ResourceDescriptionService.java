...
/**
 * The description service provides generic information about types and
 * entities. This includes general information such as the type as well as
 * description properties which are typically a subset of properties actually
 * available on an entity.
 * 
