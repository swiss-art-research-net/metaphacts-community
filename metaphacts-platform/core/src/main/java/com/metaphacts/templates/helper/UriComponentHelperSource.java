...
public class UriComponentHelperSource {
    public String encodeUriComponent(Object param0, Options options) {
        String uri = HelperUtil.toString(checkNotNull(param0, "Uri string must not be null."));
        try {
    ...
    public String decodeUriComponent(Object param0, Options options) {
        String uri = HelperUtil.toString(checkNotNull(param0, "Uri string must not be null."));
        try {
