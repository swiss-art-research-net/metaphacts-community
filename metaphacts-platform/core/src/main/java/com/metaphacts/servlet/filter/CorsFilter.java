...
import com.metaphacts.security.OptionalBasicAuthFilter;
...
public class CorsFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (StringUtils.isNotEmpty(corsOrigin) && StringUtils.isNotEmpty(requestOrigin)) {
            ...
            if (originIsAllowed) {
                // according to standard when authorization is enabled one can't return wildcard or list of origins as allowed
