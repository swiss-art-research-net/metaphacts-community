...
public class ProxyConfigs {
    ...
    public static Map<String, Map<String, String>> getConfigs(PlatformStorage platformStorage) {
        ...
        try {
            ...
            proxiesSubset.getKeys()
                    .forEachRemaining(k -> proxies.add(StringUtils.substringBefore(k, ".")));
            ...
            for (String proxyKey : proxies) {
                ...
                if (uri.getHost() == null) {
                    throw new IllegalArgumentException(
                            "Missing host for the proxy target URL: " + proxyConfig.targetUri
            ...
            logger.warn("Error while loading proxies configuration in PlatformGuiceModule:"
                    + e.getMessage());
