 ...
 *
 */
public class DigestAuthHTTPRepositoryConfig extends AuthenticatingHTTPRepositoryConfig {

    private String realm;

    public DigestAuthHTTPRepositoryConfig() {
        super(DigestAuthHTTPRepositoryFactory.REPOSITORY_TYPE);
    }
